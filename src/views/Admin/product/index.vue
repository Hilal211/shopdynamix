        ...
        <div>
          <template>
            <v-row justify="center" align="center">
              <v-btn color="secondary" @click="showDialogExcel" class="mr-3">Import</v-btn>
        ...
        <v-card>
          ...
          >
            ...
            <template v-slot:[`item.actions`]="{ item }">
              ...
              <v-icon small @click="showDialog(item)">edit</v-icon>
...
<v-dialog v-model="dialog2" scrollable persistent max-width="600px">
   <v-row>
    ...
    <v-dialog v-model="dialogexcel" scrollable persistent max-width="600px">
      <v-form ref="form" v-model="valid" lazy-validation>
        <v-card>
          <v-card-title>
            <span class="headline"
              >Import Excel File</span
            >
          </v-card-title>
          <v-card-text>
            <v-container grid-list-md>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn class="mr-2" color="secondary" @click="saveExcel" rounded>Add</v-btn>
            <v-btn
              class="px-3"
              rounded
              color="btn2"
